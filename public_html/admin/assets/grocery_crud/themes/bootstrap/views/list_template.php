<?php
    ...
    $this->set_css($this->default_theme_path.'/bootstrap/css/font-awesome/css/fontawesome-all.min.css');    
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-default" href="<?php echo $add_url?>"><i class="fas fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <a class="btn btn-default t5 gc-export" data-url="<?php echo $export_url; ?>">
                                        <i class="fas fa-cloud-download-alt floatL t3"></i>
                                ...
                                <?php if(!$unset_print) { ?>
                                    <a class="btn btn-default t5 gc-print" data-url="<?php echo $print_url; ?>">
                                        <i class="fas fa-print floatL t3"></i>
                                        <span class="hidden-xs floatL l5">
